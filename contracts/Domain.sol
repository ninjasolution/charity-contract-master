...
contract Domain is ERC721, ERC721Enumerable, AccessControl {
  ...
  constructor(string memory name, string memory symbol, address contractRegistry) ERC721(name, symbol) {
    _setupRole(DEFAULT_ADMIN_ROLE, msg.sender);
    _contractRegistry = ContractRegistryInterface(contractRegistry);
  }
}